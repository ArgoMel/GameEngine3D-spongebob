...
PS_OUTPUT_GBUFFER TerrainPS(VS_OUTPUT_STATIC input)
{
    ...
    for (int i = 0; i < g_TerrainSplatCount; ++i)
    {
        ...
        TextureColor.rgb = TextureColor.rgb * (1.f - Alpha.r) +
            SplatDif.rgb * Alpha.r;
    ...
    output.GBuffer2.rgb = ComputeBumpNormalTerrain(input.Tangent,
        input.Binormal, input.Normal, DetailUV, input.UV);
