...
{
    if (asint(g_ParticleSpawnCountMax) <= ThreadID.x)
    {
        return;
    }
    ...
    g_ParticleShare[0].CamDir = g_ParticleCamDir;
    ...
    if (g_ParticleArray[ThreadID.x].Enable == 0)
    {
        ...
        if (g_ParticleShare[0].SpawnEnable == 1)
        {
            ...
            InterlockedExchange(g_ParticleShare[0].SpawnEnable,
                InputValue, Exchange);
        ...
        float3 RandomPos = float3(RandIndex(Index), RandIndex(Index), RandIndex(Index));
        ...
        g_ParticleArray[ThreadID.x].LifeTimeMax = RandomPos.x * (g_ParticleLifeTimeMax - g_ParticleLifeTimeMin)
            + g_ParticleLifeTimeMin;
        ...
        if (g_ParticleMoveEnable == 1)
        {
            ...
            g_ParticleArray[ThreadID.x].Speed = RandomPos.x * (g_ParticleSpeedMax - g_ParticleSpeedMin)
                + g_ParticleSpeedMin;
        }
    }
    ...
    else
    {
        ...
        if (g_ParticleMoveEnable == 1)
        {
            MovePos = g_ParticleArray[ThreadID.x].Dir *
                g_ParticleArray[ThreadID.x].Speed * g_GlobalDeltaTime;
        }
        ...
        if (g_ParticleShare[0].GravityEnable == 1)
        {
            ...
            g_ParticleArray[ThreadID.x].WorldPos.y = g_ParticleArray[ThreadID.x].FallStartY + Velocity - 0.5f
                * 98.f*g_ParticleArray[ThreadID.x].FallTime * g_ParticleArray[ThreadID.x].FallTime;
            //g_ParticleShare[0].Gravity
        }
        else
        {
