...
void CPauseUI::CreateMapUI()
{
	...
	float ButtonSizeX = 190.f* ratio.x;
	float ButtonSizeY = 190.f * ratio.x;
	float ButtonPosX = 0.f;
	float ButtonPosY = 600.f * ratio.y;
	...
	Button->SetPos(ButtonPosX + LeftPadding, ButtonPosY);
	Button->SetSize(ButtonSizeX-78.f, ButtonSizeY-11.f);
	...
	Button->SetPos(ButtonPosX + LeftPadding, ButtonPosY);
	Button->SetSize(ButtonSizeX+43.f, ButtonSizeY+22.f);
...
void CPauseUI::SoundOptionUISFXMinus()
{
	...
	CResourceManager::GetInst()->SetVolume("Effect", volume - 10.f);   //Talk
...
void CPauseUI::SoundOptionUIMusicMinus()
{
	...
	// 수치 조절 후 해당 값을 Text에 SetText
	CResourceManager::GetInst()->SetVolume("BGM", volume - 10.f);   //Talk
...
void CPauseUI::SoundOptionUITalkMinus()
{
	...
	// 수치 조절 후 해당 값을 Text에 SetText
	CResourceManager::GetInst()->SetVolume("UI", volume- 10.f);   //Talk
