...
bool CUIProgressBarWindow::Init()
{
	...
	m_Slider->SetText("색상");
	m_PlayTime = CreateWidget<CEditorInputText>("재생시간", 80.f, 30.f);
	m_PlayTime->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("Line");
	m_PlayScale = CreateWidget<CEditorInputText>("재생비율", 80.f, 30.f);
	...
	m_MinInput = CreateWidget<CEditorInputText>("최소비율", 80.f, 30.f);
	m_MinInput->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("Line");
	line->SetSpacing(-5.f);
	m_MaxInput = CreateWidget<CEditorInputText>("최대비율", 80.f, 30.f);
	m_MaxInput->SetInputType(EImGuiInputType::Float);
	m_ValueInput = CreateWidget<CEditorInputText>("채움비율", 80.f, 30.f);
