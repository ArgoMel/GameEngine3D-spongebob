...
bool CStatusWindow::Init()
{
	...
	m_FXAACheck = CreateWidget<CEditorCheckBox>("FXAA");
	m_FXAACheck->SetCheck(true);
	m_FXAACheck->SetClickCallback<CStatusWindow>(this, &CStatusWindow::FXAACheckCallback);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(120.f, 30.f);
	m_MousePos[0] = CreateWidget<CEditorInputText>("MousePosX", 80.f, 30.f);
	m_MousePos[0]->SetHideName("MousePosX");
	m_MousePos[0]->SetInputType(EImGuiInputType::Float);
	m_MousePos[0]->ReadOnly(true);
	line = CreateWidget<CEditorSameLine>("line");
	m_MousePos[1] = CreateWidget<CEditorInputText>("MousePosY", 80.f, 30.f);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(120.f, 30.f);
	m_MouseWorldPos[0] = CreateWidget<CEditorInputText>("MouseWorldPosX", 80.f, 30.f);
	...
	line = CreateWidget<CEditorSameLine>("line");
	m_MouseWorldPos[1] = CreateWidget<CEditorInputText>("MouseWorldPosY", 80.f, 30.f);
	...
	line = CreateWidget<CEditorSameLine>("line");
	m_MouseWorldPos[2] = CreateWidget<CEditorInputText>("MouseWorldPosZ", 80.f, 30.f);
	m_MouseWorldPos[2]->SetHideName("MouseWorldPosZ");
	m_MouseWorldPos[2]->SetInputType(EImGuiInputType::Float);
	m_MouseWorldPos[2]->ReadOnly(true);

	label = CreateWidget<CEditorLabel>("마우스 UI 위치");
	label->SetColor(255, 0, 0, 255);
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(120.f, 30.f);
	m_MouseUIPos[0] = CreateWidget<CEditorInputText>("MouseUIPosX", 80.f, 30.f);
	m_MouseUIPos[0]->SetHideName("MouseUIPosX");
	m_MouseUIPos[0]->SetInputType(EImGuiInputType::Float);
	m_MouseUIPos[0]->ReadOnly(true);
	line = CreateWidget<CEditorSameLine>("line");
	m_MouseUIPos[1] = CreateWidget<CEditorInputText>("MouseUIPosY", 80.f, 30.f);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(120.f, 30.f);
	m_MouseMove[0] = CreateWidget<CEditorInputText>("MouseMoveX", 80.f, 30.f);
	m_MouseMove[0]->SetHideName("MouseMoveX");
	m_MouseMove[0]->SetInputType(EImGuiInputType::Float);
	m_MouseMove[0]->ReadOnly(true);
	line = CreateWidget<CEditorSameLine>("line");
	m_MouseMove[1] = CreateWidget<CEditorInputText>("MouseMoveY", 80.f, 30.f);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(120.f, 30.f);
	m_MouseMove2D[0] = CreateWidget<CEditorInputText>("MouseMove2DX", 80.f, 30.f);
	m_MouseMove2D[0]->SetHideName("MouseMove2DX");
	m_MouseMove2D[0]->SetInputType(EImGuiInputType::Float);
	m_MouseMove2D[0]->ReadOnly(true);
	line = CreateWidget<CEditorSameLine>("line");
	m_MouseMove2D[1] = CreateWidget<CEditorInputText>("MouseMove2DY", 80.f, 30.f);
...
void CStatusWindow::Update(float deltaTime)
{
	...
	Vector3 vec3 = input->GetMouseWorldPos();
	m_MouseWorldPos[0]->SetFloat(vec3.x);
	m_MouseWorldPos[1]->SetFloat(vec3.y);
	m_MouseWorldPos[2]->SetFloat(vec3.z);
...
void CStatusWindow::FXAACheckCallback(bool check)
{
	CRenderManager::GetInst()->SetFXAA(check);
}