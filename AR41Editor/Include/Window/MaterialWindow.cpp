...
bool CMaterialWindow::Init()
{
    ...
    m_Name = CreateWidget<CEditorInputText>("매터리얼 이름", 120.f, 30.f);
    ...
    m_Shader = CreateWidget<CEditorInputText>("쉐이더", 120.f, 30.f);
    line = CreateWidget<CEditorSameLine>("Line");
    m_Opacity = CreateWidget<CEditorInputText>("투명도", 80.f, 30.f);
    ...
    m_RenderState[0] = CreateWidget<CEditorInputText>("RenderState0", 100.f, 30.f);
    m_RenderState[0]->SetHideName("RenderState0");
    line = CreateWidget<CEditorSameLine>("line");
    m_RenderState[1] = CreateWidget<CEditorInputText>("RenderState1", 100.f, 30.f);
    m_RenderState[1]->SetHideName("RenderState1");
    line = CreateWidget<CEditorSameLine>("line");
    m_RenderState[2] = CreateWidget<CEditorInputText>("RenderState2", 100.f, 30.f);
    ...
    label->SetAlign(0.5f, 0.5f);
    label->SetSize(100.f, 30.f);
    m_BaseColor[0] = CreateWidget<CEditorInputText>("BaseColorX", 80.f, 30.f);
    m_BaseColor[0]->SetHideName("BaseColorX");
    m_BaseColor[0]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_BaseColor[1] = CreateWidget<CEditorInputText>("BaseColorY", 80.f, 30.f);
    m_BaseColor[1]->SetHideName("BaseColorY");
    m_BaseColor[1]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_BaseColor[2] = CreateWidget<CEditorInputText>("BaseColorZ", 80.f, 30.f);
    m_BaseColor[2]->SetHideName("BaseColorZ");
    m_BaseColor[2]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_BaseColor[3] = CreateWidget<CEditorInputText>("BaseColorW", 80.f, 30.f);
    ...
    label->SetAlign(0.5f, 0.5f);
    label->SetSize(100.f, 30.f);
    m_AmbientColor[0] = CreateWidget<CEditorInputText>("AmbientColorX", 80.f, 30.f);
    m_AmbientColor[0]->SetHideName("AmbientColorX");
    m_AmbientColor[0]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_AmbientColor[1] = CreateWidget<CEditorInputText>("AmbientColorY", 80.f, 30.f);
    m_AmbientColor[1]->SetHideName("AmbientColorY");
    m_AmbientColor[1]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_AmbientColor[2] = CreateWidget<CEditorInputText>("AmbientColorZ", 80.f, 30.f);
    m_AmbientColor[2]->SetHideName("AmbientColorZ");
    m_AmbientColor[2]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_AmbientColor[3] = CreateWidget<CEditorInputText>("AmbientColorW", 80.f, 30.f);
    ...
    label->SetAlign(0.5f, 0.5f);
    label->SetSize(100.f, 30.f);
    m_SpecularColor[0] = CreateWidget<CEditorInputText>("SpecularColorX", 80.f, 30.f);
    m_SpecularColor[0]->SetHideName("SpecularColorX");
    m_SpecularColor[0]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_SpecularColor[1] = CreateWidget<CEditorInputText>("SpecularColorY", 80.f, 30.f);
    m_SpecularColor[1]->SetHideName("SpecularColorY");
    m_SpecularColor[1]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_SpecularColor[2] = CreateWidget<CEditorInputText>("SpecularColorZ", 80.f, 30.f);
    m_SpecularColor[2]->SetHideName("SpecularColorZ");
    m_SpecularColor[2]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_SpecularColor[3] = CreateWidget<CEditorInputText>("SpecularColorW", 80.f, 30.f);
    ...
    label->SetAlign(0.5f, 0.5f);
    label->SetSize(100.f, 30.f);
    m_EmissiveColor[0] = CreateWidget<CEditorInputText>("EmissiveColorX", 80.f, 30.f);
    m_EmissiveColor[0]->SetHideName("EmissiveColorX");
    m_EmissiveColor[0]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_EmissiveColor[1] = CreateWidget<CEditorInputText>("EmissiveColorY", 80.f, 30.f);
    m_EmissiveColor[1]->SetHideName("EmissiveColorY");
    m_EmissiveColor[1]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_EmissiveColor[2] = CreateWidget<CEditorInputText>("EmissiveColorZ", 80.f, 30.f);
    m_EmissiveColor[2]->SetHideName("EmissiveColorZ");
    m_EmissiveColor[2]->SetInputType(EImGuiInputType::Float);
    line = CreateWidget<CEditorSameLine>("line");
    m_EmissiveColor[3] = CreateWidget<CEditorInputText>("EmissiveColorW", 80.f, 30.f);
