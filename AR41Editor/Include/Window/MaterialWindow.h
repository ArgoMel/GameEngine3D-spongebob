...
private:
	...
	class CEditorInputText* m_RenderState[3];
	...
	class CEditorInputText* m_BaseColor[4];
	class CEditorInputText* m_AmbientColor[4];
	class CEditorInputText* m_SpecularColor[4];
	class CEditorInputText* m_EmissiveColor[4];
	class CEditorInputText* m_Opacity;
	class CEditorInputText* m_Shader;
