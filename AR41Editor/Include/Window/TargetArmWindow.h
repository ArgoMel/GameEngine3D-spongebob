...
private:
	...
	class CEditorInputText* m_WheelSensitivity;
	class CEditorInputText* m_WheelTickMove;
	class CEditorInputText* m_WheelZoomMin;
	class CEditorInputText* m_WheelZoomMax;
