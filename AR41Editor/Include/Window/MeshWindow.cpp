...
bool CMeshWindow::Init()
{
	...
	m_Name = CreateWidget<CEditorInputText>("매쉬 이름", 100.f, 30.f);
	line = CreateWidget<CEditorSameLine>("Line");
	m_RenderCount = CreateWidget<CEditorInputText>("렌더 카운트", 80.f, 30.f);
