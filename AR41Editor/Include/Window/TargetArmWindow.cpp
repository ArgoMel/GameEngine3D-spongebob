...
bool CTargetArmWindow::Init()
{
	...
	m_WheelSensitivity = CreateWidget<CEditorInputText>("WheelSensitivity", 80.f, 30.f);
	m_WheelSensitivity->SetInputType(EImGuiInputType::Float);
	m_WheelTickMove = CreateWidget<CEditorInputText>("WheelTickMove", 80.f, 30.f);
	m_WheelTickMove->SetInputType(EImGuiInputType::Float);
	m_WheelZoomMin = CreateWidget<CEditorInputText>("WheelZoomMin", 80.f, 30.f);
	m_WheelZoomMin->SetInputType(EImGuiInputType::Float);
	m_WheelZoomMax = CreateWidget<CEditorInputText>("WheelZoomMax", 80.f, 30.f);
