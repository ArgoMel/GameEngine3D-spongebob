...
bool CRigidBodyWindow::Init()
{
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(130.f, 30.f);
	m_Force[0] = CreateWidget<CEditorInputText>("ForceX", 80.f, 30.f);
	m_Force[0]->SetHideName("ForceX");
	m_Force[0]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_Force[1] = CreateWidget<CEditorInputText>("ForceY", 80.f, 30.f);
	m_Force[1]->SetHideName("ForceY");
	m_Force[1]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_Force[2] = CreateWidget<CEditorInputText>("ForceZ", 80.f, 30.f);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(130.f, 30.f);
	m_Accel[0] = CreateWidget<CEditorInputText>("AccelX", 80.f, 30.f);
	m_Accel[0]->SetHideName("AccelX");
	m_Accel[0]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_Accel[1] = CreateWidget<CEditorInputText>("AccelY", 80.f, 30.f);
	m_Accel[1]->SetHideName("AccelY");
	m_Accel[1]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_Accel[2] = CreateWidget<CEditorInputText>("AccelZ", 80.f, 30.f);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(130.f, 30.f);
	m_AccelA[0] = CreateWidget<CEditorInputText>("AccelAX", 80.f, 30.f);
	m_AccelA[0]->SetHideName("AccelAX");
	m_AccelA[0]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_AccelA[1] = CreateWidget<CEditorInputText>("AccelAY", 80.f, 30.f);
	m_AccelA[1]->SetHideName("AccelAY");
	m_AccelA[1]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_AccelA[2] = CreateWidget<CEditorInputText>("AccelAZ", 80.f, 30.f);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(130.f, 30.f);
	m_Velocity[0] = CreateWidget<CEditorInputText>("VelocityX", 80.f, 30.f);
	m_Velocity[0]->SetHideName("VelocityX");
	m_Velocity[0]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_Velocity[1] = CreateWidget<CEditorInputText>("VelocityY", 80.f, 30.f);
	m_Velocity[1]->SetHideName("VelocityY");
	m_Velocity[1]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_Velocity[2] = CreateWidget<CEditorInputText>("VelocityZ", 80.f, 30.f);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(130.f, 30.f);
	m_MaxVelocity[0] = CreateWidget<CEditorInputText>("MaxVelocityX", 80.f, 30.f);
	m_MaxVelocity[0]->SetHideName("MaxVelocityX");
	m_MaxVelocity[0]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_MaxVelocity[1] = CreateWidget<CEditorInputText>("MaxVelocityY", 80.f, 30.f);
	m_MaxVelocity[1]->SetHideName("MaxVelocityY");
	m_MaxVelocity[1]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_MaxVelocity[2] = CreateWidget<CEditorInputText>("MaxVelocityZ", 80.f, 30.f);
	...
	label->SetAlign(0.5f, 0.5f);
	label->SetSize(130.f, 30.f);
	m_MinVelocity[0] = CreateWidget<CEditorInputText>("MinVelocityX", 80.f, 30.f);
	m_MinVelocity[0]->SetHideName("MinVelocityX");
	m_MinVelocity[0]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_MinVelocity[1] = CreateWidget<CEditorInputText>("MinVelocityY", 80.f, 30.f);
	m_MinVelocity[1]->SetHideName("MinVelocityY");
	m_MinVelocity[1]->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_MinVelocity[2] = CreateWidget<CEditorInputText>("MinVelocityZ", 80.f, 30.f);
	m_MinVelocity[2]->SetHideName("MinVelocityZ");
	m_MinVelocity[2]->SetInputType(EImGuiInputType::Float);

	m_Mass = CreateWidget<CEditorInputText>("질량", 80.f, 30.f);
	m_Mass->SetInputType(EImGuiInputType::Float);
	line = CreateWidget<CEditorSameLine>("line");
	m_FricCoeff = CreateWidget<CEditorInputText>("마찰계수", 80.f, 30.f);
	m_FricCoeff->SetInputType(EImGuiInputType::Float);

	m_GravityForce = CreateWidget<CEditorInputText>("중력값", 80.f, 30.f);
