...
float ComputeFog(float distance, float start, float end)
{
    float result = (end - distance) / (end - start);
    return clamp(result,0,1);
}

float ComputeFogColor(float distance, float start, float end)
{
    float result = (end - distance) / (end - start);
    return clamp(result, 0, 1);
}
